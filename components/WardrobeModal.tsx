...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
  ...
  return (
    <div className="pt-6 border-t border-y2k-blue/30">
        <h2 className="text-xl font-serif tracking-wider text-y2k-blue mb-3">WARDROBE</h2>
        <div className="grid grid-cols-3 gap-3">
            ...
            return (
                ...
                className="relative aspect-square border border-y2k-blue/20 rounded-lg overflow-hidden transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-y2k-blue group disabled:opacity-60 disabled:cursor-not-allowed"
                ...
                {isActive && (
                    <div className="absolute inset-0 bg-y2k-blue/70 flex items-center justify-center">
            ...
            <label htmlFor="custom-garment-upload" className={`relative aspect-square border-2 border-dashed border-y2k-blue/50 rounded-lg flex flex-col items-center justify-center text-y2k-blue transition-colors ${isLoading ? 'cursor-not-allowed bg-y2k-blue/5' : 'hover:border-y2k-blue hover:bg-y2k-blue/10 cursor-pointer'}`}>
